...
config. Duration		= 2200			// Time span in ms after which the tooltip disappears; 0 for infinite duration, < 0 for delay in ms _after_ the onmouseout until the tooltip disappears
...
config. OffsetX			= 200	// Horizontal offset of left-top corner from mousepointer
...
config. TitleAlign		= 'lft'	// 'left' or 'right' - text alignment inside the title bar
config. TitleBgColor	= '#173F59'		// If empty string '', BorderColor will be used
