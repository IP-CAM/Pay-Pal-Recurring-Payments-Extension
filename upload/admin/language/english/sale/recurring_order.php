...
// Heading
            ...
            $_['recurring_tab']     = 'Recurring Profile Details'; 
			$_['edit_recurring_tab']     = 'Edit Recurring Profile';
			$_['refund_recurring_tab']     = 'Refund Manager'; 
			$_['column_parent_orders']     = 'Recurring Orders'; 
		    $_['column_profile_id']     = 'Profile ID'; 
			$_['recurring_profile_id']     = 'Profile ID:'; 
			$_['recurring_profile_desc']     = 'Profile Description:';
			$_['recurring_profile_status']     = 'Profile Status:';
			$_['recurring_trial_status']     = 'Trial Status:';
			$_['recurring_profile_autobill']     = 'Autobill Debted Amount?';
			$_['recurring_profile_startdate']     = 'Profile Start Date:';
			$_['recurring_profile_subscribename']     = 'Subscriber Name:';
			$_['recurring_profile_email']     = 'Subscriber Email:';
			$_['recurring_profile_reference']     = 'Reference ID:';
			$_['recurring_profile_maxfailed']     = 'Max Failed Payments:';
			$_['recurring_profile_billingperiod']     = 'Trial Billing Period:'; 
			$_['recurring_profile_regularbillingperiod']     = 'Regular Billing Period:';
			$_['recurring_profile_billingfrequency']     = 'Trial Billing Frequency:';
			$_['recurring_profile_regularbillingfrequency']     = 'Regular Billing Frequency:';
			$_['recurring_profile_taxamt']     = 'Trial Tax Amount:'; 
			$_['recurring_profile_regulartaxamt']     = 'Regular Tax Amount:';
			$_['recurring_profile_aggtotal']     = 'Aggregate Total';
			$_['tab_order_history']     = 'Recurring Order History';
			$_['recurring_profile_shippingamt']     = 'Trial Shipping Amount:';
			$_['recurring_profile_regularshipingamt']     = 'Regular Shipping Amount:';
			$_['recurring_profile_taxamt']     = 'Trial Tax Amount:'; 
			$_['recurring_profile_regulartaxamt']     = 'Regular Tax Amount:';
			$_['recurring_profile_shippingamt']     = 'Trial Shipping Amount:';
			$_['recurring_profile_regularshipingamt']     = 'Regular Shipping Amount:';
			$_['recurring_profile_amt']     = 'Trial Amount:'; 
			$_['recurring_profile_regularamt']     = 'Regular Profile Amount:';
			$_['recurring_profile_totalbillingcycles']     = 'Trial Total Billing Cycles:';
			$_['recurring_profile_regulartotalbillingcycles']     = 'Regular Total Billing Cycles:';		
			$_['recurring_profile_nextbilldate']     = 'Next Billing Date:';
			$_['recurring_profile_cyclescompleted']     = 'Cycles Completed';
			$_['recurring_profile_cyclesremaining']     = 'Cycles Remaining';
			$_['recurring_profile_failedcount']     = 'Failed Payment Attempts:';		
			$_['recurring_profile_lastpaymentdate']     = 'Last Payment Date:';
			$_['recurring_profile_lastpaymentamount']     = 'Last Payment Amount:';
			$_['recurring_profile_outstanding']     = 'Outstanding Balance';
			$_['update_recurring_profile_outstanding_text']     = 'There <i>must</i> already be an outstanding balance, and it <i>must</i> be lower than the amount.';
			$_['recurring_profile_cctype']     = 'CC Type:';
			$_['recurring_profile_ccnumber']     = 'CC Number:';		
			$_['recurring_profile_ccexpire']     = 'CC Expire:';
			$_['recurring_profile_maestrostartdate']     = 'Maestro Start Date:';
			$_['recurring_profile_maestronumber']     = 'Maestro Number:';
			$_['update_recurring_note']     = 'Note:';
			$_['update_recurring_additionalbillingcycles']     = 'Additional Billing Cycles:';
			$_['text_enabled']     = 'Enabled';
			$_['text_disabled']     = 'Disabled';
			$_['mustnot']     = '(Cannot be before proile creation date and must not already have started)';
			$_['text_credit_card']     = 'Credit Card Details';
			$_['jump']     = 'Edit Recurring Settings';
$_['text_start_date']      = '(if available)';
$_['text_issue']           = '(maestro and solo only)';
...
$_['isrecurring']       = 'Is Recurring Profile';
$_['hastrial']       = 'Has Trial';

$_['text_reactivate']       = '<b>*Reactivate:</b> Only profiles that are suspended may be reactivated. <i>However, if there is a delinquent amount owed and no more scheduled payments, selected profile cannot be reactivated.</i><br />';
$_['text_cancel']       = '<b> *Cancel:</b> Cancels the profile. Profile cannot be reactivated.';
$_['text_suspend']       = '<b>*Suspend:</b> This will suspend the profile indefinately until canceled or reactivated.<br />';
$_['heading_title']                           = 'Paypal Recurring Orders';
...
$_['column_status']                           = 'Profile Status';
$_['column_date_added']                       = 'Date Added';
$_['column_date_modified']                    = 'Date Modified';
$_['column_total']                            = 'Initial Total';
