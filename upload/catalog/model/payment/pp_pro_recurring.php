<?php 
class ModelPaymentPPProRecurring extends Model {
  	public function getMethod($address, $total) { 
		$this->load->language('payment/pp_pro_recurring');
		...
		if ($this->config->get('pp_pro_recurring_total') > $total) {
			$status = false;
