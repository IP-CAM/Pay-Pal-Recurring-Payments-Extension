...
//==============================================================================
?>
<h2><img src="catalog/view/theme/default/image/recurring.jpg" alt="" /> <?php echo $text_credit_card; ?></h2>
<div class="content" id="payment">
  <table class="form">
    <tr>
      <td>
 <?php echo $entry_cc_type; ?></td>
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		url: 'index.php?route=payment/pp_pro_recurring/send',
		type: 'post',
		data: $('#payment :input'),
		dataType: 'json',		
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['transactionforward']) {
				location = json['transactionforward'];
			}
